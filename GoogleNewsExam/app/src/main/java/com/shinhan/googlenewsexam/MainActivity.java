        ...
        * */
        ...
        private RSSNewsItem dissectNode(NodeList nodeList, int index){//아이템정보 추출
            ...
            try{
                ...
                String descroptionValue = getElementString(description);
                ...
                newsItem = new RSSNewsItem(titleValue,linkValue,descroptionValue,pubDateValue,authorValue,categoryValue);
            }catch (Exception e){
                e.printStackTrace();
            }
        ...
        private String getElementString(Element element){  //element객체에서 문자열 추출하는!
            String value = null;
            if(element!=null){
